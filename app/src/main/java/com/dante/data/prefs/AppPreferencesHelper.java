...
public class AppPreferencesHelper implements PreferencesHelper {
    ...
    public final static String KEY_SP_PORN_91_VIDEO_ADDRESS = "key_sp_91_porn_address";
    public final static String KEY_SP_FORUM_91_PORN_ADDRESS = "key_sp_91_forum_address";
    ...
    public String getPorn91VideoAddress() {
        return mPrefs.getString(KEY_SP_PORN_91_VIDEO_ADDRESS, Api.PORN91_VIDEO_DOMAIN_NAME);
    }
    ...
    public String getPorn91ForumAddress() {
        return mPrefs.getString(KEY_SP_FORUM_91_PORN_ADDRESS, Api.PORN91_FORUM_DOMAIN_NAME);
    }
