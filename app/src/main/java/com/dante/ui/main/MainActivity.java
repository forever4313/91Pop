...
import com.dante.service.UpdateDownloadService;
import com.dante.ui.BaseFragment;
...
import com.dante.ui.pigav.MainPigAvFragment;
import com.dante.ui.porn91forum.Main91ForumFragment;
import com.dante.ui.porn91video.Main91PronVideoFragment;
...
import com.dante.utils.ApkVersionUtils;
import com.dante.utils.FragmentUtils;
...
import com.dante.utils.constants.PermissionConstants;
        ...
        public void onSucceed(int requestCode, @NonNull List<String> grantedPermissions) {
            ...
            if (requestCode == permisionCode) {
                ...
                if (AndPermission.hasPermission(MainActivity.this, grantedPermissions)) {
                    if (!file.exists()) {
                        if (!file.mkdirs()) {
                            showMessage("创建下载目录失败", TastyToast.ERROR);
                        }
                    }
                } else {
        ...
        bottomNavigationBar.setTabSelectedListener(new BottomNavigationBar.SimpleOnTabSelectedListener() {
            ...
            public void onTabReselected(int position) {
                ...
                if (mCurrentFragment instanceof BaseFragment) {
                    ((BaseFragment) mCurrentFragment).scrollToTop();
                }
            }
...
//                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == permisionReqCode) {
            if (!AndPermission.hasPermission(MainActivity.this, permission)) {
                showMessage("拒绝存储权限将影响下载视频等功能", TastyToast.WARNING);
            }
        }
    ...
    public void onBackPressed() {
        ...
        showMessage("再点一次退出程序", TastyToast.INFO);
