...
public class GoogleRecaptchaVerifyActivity extends MvpActivity<GoogleRecaptchaVerifyView, GoogleRecaptchaVerifyPresenter> implements GoogleRecaptchaVerifyView {
    ...
    private void initDialog() {
        verifyAlertDialog = DialogUtils.initLodingDialog(this, "正在验证中，请稍候...");
        checkNeedVerifyDialog = DialogUtils.initLodingDialog(this, "检查中,请稍候...");
        loadVerifyPageDialog = DialogUtils.initLodingDialog(this, "加载验证网页中...");
    }
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
            ...
            if (url.contains("?__cf_chl_captcha_tk__")) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        webView.evaluateJavascript("javascript:getPostData()", new ValueCallback<String>() {
                            @Override
