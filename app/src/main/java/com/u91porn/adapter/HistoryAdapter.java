...
public class HistoryAdapter extends BaseQuickAdapter<UnLimit91PornItem, BaseViewHolder> {

    public HistoryAdapter(int layoutResId, @Nullable List<UnLimit91PornItem> data) {
